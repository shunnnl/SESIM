from sqlalchemy import Column, Integer, String, Text, Boolean, DateTime, Float, ForeignKey, CHAR
...
class DeploymentLog(Base):
    ...
    deployment_log_id = Column(Integer, primary_key=True)
...
class AITrain(Base):
    ...
    ai_train_id = Column(Integer, primary_key=True)
    model_id = Column(Integer, ForeignKey("models.model_id"), nullable=False)
