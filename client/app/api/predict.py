...
def predict(
    ...
    try:
        ...
        # 3. AI 서버 URL 구성
        ai_url = f"{settings.AI_SERVER_BASE_URL}{model.model_id}:{settings.AI_SERVER_PORT}/api/predict"
...
#
#         # 3. AI 서버로 예측 요청
#         # ai_url = f"{settings.AI_SERVER_BASE_URL}{request.model_id}:{settings.AI_SERVER_PORT}/api/predict"
#         ai_url = "http://ai-server:8000"
#         results = send_to_ai_model(ai_url, parsed_logs)
#
