...
export const AiModelCard = ({ id, name, featureTitle, featureList }: AiModelCardProps) => {
    ...
    return (
        <div
            className={`bg-gradient-to-br from-[#24273D] via-[#373D6A] to-[#24273D] rounded-[10px] border-[1px] border-[#505671] px-[45px] py-[40px] w-[320px] h-[310px] relative transition-all duration-300 hover:-translate-y-2 ${isButtonHover ? "z-10" : ""}`}
