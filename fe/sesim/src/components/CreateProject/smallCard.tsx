...
export const SmallCard : React.FC<SmallCardProps> = ({ description, modelName, isSelected, onClick }) => {
    return (
        <button 
            onClick={onClick}
            className={`flex flex-col items-center bg-[#242C4D] rounded-[20px] border-[#505671] border-[1px] px-[30px] py-[20px] w-[210px] hover:bg-[#3C4061] transition-all duration-200 ${
