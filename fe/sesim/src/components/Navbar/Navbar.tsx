...
export const Navbar: React.FC<NavbarProps> = ({
    ...
    return (
        ...
        <nav className={`border-b-2 ${isMypageRoute ? "border-[#1d2433]" : "border-white/20"} sticky top-0 z-50 transition-all duration-400 ${isScrolled ? "backdrop-blur-md bg-black/50" : ""}`}>
