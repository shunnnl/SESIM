  ...
  data.forEach(dailyItem => {
    ...
    try {
      ...
      if (!dailyData[dateKey]) {
        dailyData[dateKey] = {
          date: displayDate,
          totalCost: dailyItem.totalCost || 0
        };
      }
  ...
  return (
    <div className="flex flex-row flex-wrap gap-x-8 gap-y-2 justify-center items-center">
      <div className="flex flex-row gap-2 items-center">
        ...
        />
        <p className="text-sm font-semibold text-gray-400">총 비용</p>
      </div>
...
export default function DailyAllProjectCostChart({ data }: { data: DailyProjectCost[] | null }) {
