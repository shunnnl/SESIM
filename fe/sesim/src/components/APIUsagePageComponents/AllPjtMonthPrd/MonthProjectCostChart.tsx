...
const CustomCostLegend = (props: { payload?: Array<{ value: number, payload: ProjectCost }>, nameMap: Record<number, string> }) => {
...
export default function MonthProjectCostChart({ data }: { data: ProjectCost[] }) {
