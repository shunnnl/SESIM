...
import DailyCumulativeCostChart from "./graph/DailyCumulativeCostChart";

export const AllProjectsPeriodView: React.FC = () => {
  return (
      ...
      <div className="flex flex-col my-[16px] gap-4">
        ...
        >
          <div className="flex flex-row gap-3 items-center">
            ...
            <p className="text-md font-semibold text-left text-[#DEDEDE]">최근 3개월 동안 비용 일일 누적합 그래프</p>
          </div>
          <DailyCumulativeCostChart />
        </motion.div>
      </div>
    </div>
  );
