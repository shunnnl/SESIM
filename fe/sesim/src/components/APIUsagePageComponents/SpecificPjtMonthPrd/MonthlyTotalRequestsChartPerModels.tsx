...
import { ModelRequest } from "../../../types/APIUsageTypes";
...
export default function MonthlyTotalCostChartPerModels({ data }: { data: ModelRequest[] }) {
  ...
  return (
    <div className="w-full h-[300px] px-4 pb-4 backdrop-blur-md shadow-inner z-10">
      ...
      >
        ...
        >
          <Tooltip
            content={<CustomTooltip nameMap={modelNames} suffix="건" />}
